...
static void native_to_managed_trampoline_44 (id self, SEL _cmd, MonoMethod **managed_method_ptr, UIPanGestureRecognizer * p0, const char *r0, const char *r1, const char *r2)
{
	NSObject *nsobj0 = NULL;
	MonoObject *mobj0 = NULL;
	int32_t created0 = false;
...
@implementation __UIPanGestureRecognizer { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_44 (self, _cmd, &managed_method, p0, "UIKit.UIPanGestureRecognizer, Xamarin.iOS", "UIKit.UIPanGestureRecognizer+Callback, Xamarin.iOS", "Activated");
	}
@end
...
void xamarin_create_classes () {
	...
	__xamarin_class_map [45].handle = objc_getClass ("SFSafariViewController");
	__xamarin_class_map [46].handle = objc_getClass ("UIImage");
	__xamarin_class_map [47].handle = objc_getClass ("CSSearchableIndex");
	__xamarin_class_map [48].handle = objc_getClass ("CSSearchableItem");
	__xamarin_class_map [49].handle = objc_getClass ("UIImageView");
	__xamarin_class_map [50].handle = objc_getClass ("CSSearchableItemAttributeSet");
	...
	__xamarin_class_map [87].handle = objc_getClass ("NSURLCache");
	...
	__xamarin_class_map [99].handle = objc_getClass ("UIActivity");
	...
	__xamarin_class_map [124].handle = objc_getClass ("UIAlertView");
	__xamarin_class_map [125].handle = objc_getClass ("UIApplication");
	...
	__xamarin_class_map [151].handle = objc_getClass ("UIKit_UIActionSheet__UIActionSheetDelegate");
	__xamarin_class_map [152].handle = objc_getClass ("UIKit_UIAlertView__UIAlertViewDelegate");
	__xamarin_class_map [153].handle = objc_getClass ("UIKit_UIBarButtonItem_Callback");
